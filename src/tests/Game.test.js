...
import {render, screen, userEvent, cleanup, act, waitFor} from "@testing-library/react"
...
describe("the game page renders the correct game", () => {
    test("a game renders when id is passed", async() => {
        const favourites = [/* put some initial favourites here */];
